...
class LocalExplainer:
    ...
    def explain(self, data: numpy.ndarray, algorithm: str = "weights") -> Tuple[int, numpy.ndarray]:
        """
        Explain the model on the given input.
        Args:
            data: The input data.
            algorithm: Explanation algorithm to use: one of "weights" or "shap".
